...
_classify_cases = {
    ...
    'qbit_metadata': (['qBittorrent is downloading metadata'], 'generic'),
    ...
    'stalled_no_connections': (['The download is stalled with no connections'], 'generic'),
    'stalled_no_peers': (['The download is stalled with no peers'], 'generic'),
    'stalled_locked': (['File is locked by another process'], 'generic'),
